...
% However, it is your responsibility to assure that you have met all b 
...
% C O V E R  P A G E
% ------------------
\newcommand{\thesisauthor}{Zhifei Fang}
...
\include{parts/30-casestudy}
\include{parts/40-protocols}
\include{parts/50-demonstration}
\include{parts/60-experiment}
\include{parts/70-conclusion}
